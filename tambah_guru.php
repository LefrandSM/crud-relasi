...
if (isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO tb_guru
                VALUES
            ('', '$nama', '$jenis_kelamin', '$id_mapel', '$nip', '$alamat', '$tgl_lahir', '$jurusan_guru')";
...
<body>
    ...
    <div class="konten container">
        <h1 class="p-3 text-center">Tambah Guru</h1>
        ...
        <form action="" method="post" class="my-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama_guru">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary" name="tambah">Tambah Data Guru</button>
        </form>
    </div>
